...
<div class="min-h-screen w-full relative overflow-hidden py-12">
    ...
    <div id="quiz-container" class="relative max-w-xl mx-auto text-center text-white">
        ...
        <div id="section-tutor">
            <h1 class="text-3xl font-bold mb-3 drop-shadow-lg">Level 1 - Pengurangan</h1>
            <p class="mb-4">Pelajari materi sebelum mulai mengerjakan soal.</p>
            <img src="/images/pengurangan.png" class="mx-auto w-64 mb-4">
            <div class="bg-white text-black p-4 rounded-2xl shadow-xl mb-6">
                <p>pengurangan adalah menjumlahkan dua angka untuk mendapatkan totalnya.</p>
                <p>Contoh: 3 - 2 = 1</p>
            </div>
...
<div id="section-result" class="hidden text-black">
    <div class="bg-white p-4 rounded-2xl shadow-xl">
        ...
        <a href="{{ route('quiz.level', ['operation' => 'pengurangan', 'level' => 2]) }}"
           class="mt-4 block bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-xl font-bold w-full text-center">
            Lanjut ke Level 2
        </a>

        <!-- Tombol Kembali ke Halaman pengurangan Utama (opsional) -->
...
<script>
const questions = [
    { text: "3 - 2 = ?", answer: 1, image: "/images/quiz/21.png" },
    { text: "6 - 4 = ?", answer: 2, image: "/images/quiz/43.png" },
    { text: "8 - 3 = ?", answer: 5, image: "/images/quiz/15.png" }
];
...
function showResult() {
    ...
    fetch('/quiz/pengurangan/complete-level/1', {
        method: 'POST',
        headers: {
