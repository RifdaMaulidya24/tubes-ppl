...
<div class="min-h-screen w-full relative overflow-hidden py-12">
    ...
    <div id="quiz-container" class="relative max-w-xl mx-auto text-center text-white">
        ...
        <div id="section-tutor">
            <h1 class="text-3xl font-bold mb-3 drop-shadow-lg">Level 2 - Pengurangan</h1>
...
<div id="section-result" class="hidden text-black">
    <div class="bg-white p-4 rounded-2xl shadow-xl">
        ...
        <a href="{{ route('quiz.level', ['operation' => 'pengurangan', 'level' => 3]) }}"
...
<script>
const questions = [
    { text: "2 + 1 = ?", answer: 3, image: "/images/quiz/21.png" },
    { text: "4 + 3 = ?", answer: 7, image: "/images/quiz/43.png" },
    { text: "1 + 5 = ?", answer: 6, image: "/images/quiz/15.png" }
];
