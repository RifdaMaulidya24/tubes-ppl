...
<head>
  ...
  <title>Quiz Level 1 - Perkalian</title>
  ...
  <style>
    ...
    .zoom-in{animation:zoomIn .3s ease-out forwards}
    .zoom-out{animation:zoomOut .3s ease-out forwards}
    ...
    .delay-0{animation-delay:0ms}.delay-75{animation-delay:75ms}.delay-100{animation-delay:100ms}.delay-150{animation-delay:150ms}
    .delay-200{animation-delay:200ms}.delay-300{animation-delay:300ms}.delay-400{animation-delay:400ms}.delay-500{animation-delay:500ms}.delay-700{animation-delay:700ms}
      ...
      <div class="w-full max-w-3xl">
        ...
        <div id="section-tutor" class="transition-all duration-500 ease-out text-center text-white max-w-xl mx-auto px-6 py-10 sm:py-14">
          ...
          <div class="mt-7 flex justify-center animate-fade-zoom delay-100">
            <img src="/img/anu.png" alt="Onboarding Perkalian"
          ...
          <p class="mt-6 text-white/80 text-gl sm:text-[17px] leading-relaxed max-w-md mx-auto animate-fade-zoom delay-200">
            Perkalian itu pengulangan penjumlahan. Baca singkatnya dulu, lalu mulai kuis
          </p>
        ...
        <div id="section-result" class="hidden transition-all duration-500 ease-out text-black animate-fade-zoom delay-0">
          <div class="bg-white/95 p-6 rounded-3xl shadow-2xl border border-white/40 max-w-xl mx-auto text-center">
            ...
            <button onclick="unlockAndGoBack()" id="btn-go-back"
              class="mt-3 block bg-gradient-to-r from-purple-700 to-fuchsia-700 hover:from-purple-800 hover:to-fuchsia-800
                     text-white p-4 rounded-2xl font-extrabold w-full text-center transition shadow-xl active:scale-[0.99]">
              Kembali
            </button>
          </div>
...
const questions = [
  ...
  { text: "4 × 2 = ?", answer: 8 },
  {
      text: "Ani memiliki 2 kantong. Setiap kantong berisi 2 permen. Berapa jumlah permen Ani?",
      answer: 4
    },
    {
      text: "Budi mempunyai 3 piring. Setiap piring berisi 2 kue. Berapa jumlah kue seluruhnya?",
      answer: 6
    },
    {
      text: "Di meja ada 3 kotak. Setiap kotak berisi 3 pensil. Berapa jumlah pensil semuanya?",
      answer: 9
    },
    {
      text: "Ibu membeli 4 kantong jeruk. Setiap kantong berisi 3 jeruk. Berapa jumlah jeruk ibu?",
      answer: 12
    }
];
...
function unlockAndGoToNextLevel() {
  ...
  .then(r => r.json())
  .then(data => {
    if (data.status === 'ok' || data.success) window.location.href = '/quiz/perkalian/level2';
    else {
