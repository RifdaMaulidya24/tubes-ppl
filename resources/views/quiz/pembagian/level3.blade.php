      ...
      <div class="w-full max-w-3xl">
        ...
        <div id="section-tutor" class="transition-all duration-500 ease-out text-center text-white max-w-xl mx-auto px-6 py-10 sm:py-14">
          ...
          <p class="mt-6 text-white/80 text-gl sm:text-[17px] leading-relaxed max-w-md mx-auto animate-fade-zoom delay-200">
            Pembagian makin seru! Bagi angka dengan tepat, lalu mulai kuis ya.
          </p>

          <div class="mt-6 rounded-3xl bg-white/50 border border-white/15 p-4 text-left animate-fade-zoom delay-300">
            <p class="text-sm text-orange-900">Ingat: <b>hasil pembagian</b> adalah berapa kali angka bisa dibagi.</p>
...
const questions = [
  ...
  { text: "75 ÷ 5 = ?", answer: 15 },
  {
    text: "Ani memiliki 24 permen dan 2 cokelat. Permen tersebut akan dibagikan sama banyak kepada 6 temannya saat ulang tahun. Berapa permen yang diterima setiap teman?",
    answer: 4
  },
  {
    text: "Di kelas Budi terdapat 5 meja dan 1 papan tulis. Budi membawa 25 kue untuk dibagikan sama rata ke setiap meja. Berapa kue di setiap meja?",
    answer: 5
  },
  {
    text: "Guru membawa 27 pensil dan 3 penghapus ke kelas. Pensil tersebut akan dibagikan sama banyak kepada 9 siswa. Berapa pensil yang diterima setiap siswa?",
    answer: 3
  },
  {
    text: "Ibu membeli 30 jeruk dan 1 semangka di pasar. Jeruk tersebut dimasukkan ke dalam 6 kantong dengan jumlah yang sama. Berapa jeruk di setiap kantong?",
    answer: 5
  }
];
...
function saveProgress(finalScore) {
  fetch('/quiz/pembagian/complete-level/3', {
    method: 'POST',
    headers: {
...
function unlockAndGoToNextLevel() {
  ...
  .then(r => r.json())
  .then(data => {
    if (data.status === 'ok' || data.success) window.location.href = '/quiz/pembagian/level4';
    else {
