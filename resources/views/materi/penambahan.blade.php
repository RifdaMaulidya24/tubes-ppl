<x-app-layout>
    <style>
        ...
        .materi-bg {
            position: absolute;
            inset: 0;
            background: linear-gradient(to bottom right, #42a5f5, #2196f3, #1976d2);
        }
        ...
        .card {
            ...
            background: rgba(255,255,255,0.92);
            border: 1px solid rgba(255,255,255,0.22);
            box-shadow: 0 16px 55px rgba(0,0,0,0.14);
            overflow: hidden;
            position: relative;
        }
        ...
        .card-sub{ margin: 0; color: rgba(15,23,42,0.75); font-weight: 700; line-height: 1.75; font-size: 13.5px;}
        .card-sub.light{ color: rgba(255,255,255,0.86); }
        ...
        .choice:hover{ transform: translateY(-2px); background: rgba(255,255,255,0.18); }
        .choice.correct{
        ...
        <p class="mascot-mini">Tambah angka jadi makin jago ✨</p>
            ...
            <div class="grid">
                ...
                <div class="card">
                    ...
                    <ul style="margin:0; padding-left: 18px; color: rgba(15,23,42,0.75); font-weight:800; line-height:1.8; font-size: 13.5px;">
                        <li>2 + 3 = 5</li>
                        <li>10 + 4 = 14</li>
                        <li>7 + 1 = 8</li>
                    </ul>
            ...
            <div class="card" style="margin-top:16px;">
                ...
                <ul style="margin:0; padding-left: 18px; color: rgba(15,23,42,0.75); font-weight:800; line-height:1.9; font-size: 13.5px;">
