<x-app-layout>
    <style>
        ...
        .materi-bg{position:absolute;inset:0;background:linear-gradient(to bottom right,#66bb6a,#4caf50,#2e7d32);}
        ...
        <div class="container-materi">
            ...
            <div class="hero">
                <div class="hero-card">
                    <div class="chip-row">
                        ...
                        <div class="chip">➖ Pengurangan</div>
                    </div>

                    <h1 class="hero-title">Materi Pengurangan ➖</h1>
                    <p class="hero-desc">
                        Pengurangan adalah proses <b>mengambil</b> atau <b>mengurangi</b> jumlah dari sebuah angka.
                        Bayangin kamu punya permen, lalu ada yang diambil — sisanya itu hasil pengurangan 😄
                    </p>
                ...
                <div class="hero-mascot">
                    ...
                    <p class="mascot-mini">
                        Kalau bisa, <b>kurangi dari angka yang lebih besar</b>.
                        Ingat: hasil pengurangan biasanya lebih kecil.
                    </p>
                </div>
            </div>
            ...
            <div class="grid">
                <div class="card">
                    ...
                    <p class="card-sub">
                        ...
                        Hasil akhirnya disebut <b>selisih</b>.
                    </p>
                    ...
                    <div class="sum-row" id="latihan">
                        <input id="a" class="num-box" type="number" value="8" min="0" />
                        <div class="op">−</div>
                ...
                <div class="card soft" id="video">
                    ...
                    <div class="video-wrap">
                        <iframe
                            src="https://www.youtube.com/embed/y6-eQOlKVBE?si=JNWAF12ilY0IkC4d"
                            title="Video Materi Pengurangan"
                    ...
                    <div class="mini-quiz" id="miniQuiz">
                        <div class="quiz-q">Berapa hasil dari <b>9 − 4</b> ?</div>
                        <div class="quiz-choices">
                            <div class="choice" data-answer="6">6</div>
            ...
            <div class="card" style="margin-top:16px;">
                ...
                <ul style="margin:0;padding-left:18px;color:rgba(15,23,42,.75);font-weight:800;line-height:1.9;font-size:13.5px;">
                    ...
                    <li>Hitung mundur: 10 − 3 = 9, 8, 7 → hasilnya 7.</li>
                    <li>Pastikan <b>angka pertama</b> lebih besar biar gampang.</li>
                </ul>
            </div>
    ...
    <script>
        ...
        a.addEventListener('input', updateSub);
        b.addEventListener('input', updateSub);
        updateSub();
