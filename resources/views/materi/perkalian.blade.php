<x-app-layout>
    <style>
        ...
        .materi-bg{position:absolute;inset:0;background:linear-gradient(to bottom right,#ab47bc,#8e24aa,#6a1b9a);}
        ...
        <p class="mascot-mini">Latihan kali biar makin pro ✨</p>
            ...
            <div class="grid">
                <div class="card">
                    ...
                    <p class="card-sub">
                        Perkalian itu menggabungkan <b>kelompok yang sama</b>.
                        Misal ada 3 kantong, tiap kantong isi 4 permen, totalnya 3 × 4.
                    </p>
                    ...
                    <div class="sum-row" id="latihan">
                        <input id="a" class="num-box" type="number" value="3" min="0" />
                        <div class="op">×</div>
                        <input id="b" class="num-box" type="number" value="4" min="0" />
                        <div class="op">=</div>

                        <div class="result-pill">
                            <span class="spark">⭐</span>
                            <span>Hasil: <span id="hasil">12</span></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card soft" id="video">
                    ...
                    <div class="video-wrap">
                        <iframe
                            src="https://www.youtube.com/embed/cLttT5ABb5s?si=m8XnLVG7eMRezUEM"
                            title="Video Materi Perkalian"
                    ...
                    <div class="mini-quiz" id="miniQuiz">
                        <div class="quiz-q">Berapa hasil dari <b>6 × 2</b> ?</div>
                        <div class="quiz-choices">
                            <div class="choice" data-answer="10">10</div>
                            <div class="choice" data-answer="12">12</div>
                            <div class="choice" data-answer="14">14</div>
            ...
            <div class="card" style="margin-top:16px;">
                ...
                <ul style="margin:0;padding-left:18px;color:rgba(15,23,42,.75);font-weight:800;line-height:1.9;font-size:13.5px;">
                    <li>2×, 5×, 10× itu paling gampang, kuasai dulu.</li>
                    <li>Gunakan <b>penjumlahan berulang</b> kalau lupa.</li>
                    <li>3 × 4 sama dengan 4 × 3 (boleh ditukar).</li>
                </ul>
            </div>

            <div class="bottom-actions">
                <a href="{{ route('materi.index') }}" class="btn btn-ghost">⬅ Kembali</a>
                <a href="{{ url('/quiz/perkalian') }}" class="btn btn-light">🚀 Mulai Quiz Perkalian</a>
            </div>
        </div>
    </div>

    <script>
        // Interaktif perkalian (a * b)
        ...
        a.addEventListener('input', updateMul);
        b.addEventListener('input', updateMul);
        updateMul();
