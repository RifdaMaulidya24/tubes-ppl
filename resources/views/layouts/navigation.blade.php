<nav x-data="{ open: false }" 
     class="bg-[#0f1a2b] border-b border-gray-700 text-white">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 
                                       ...
                                       text-gray-200 bg-[#0f1a2b] 
                                       hover:text-white hover:bg-gray-800 
                                       focus:outline-none transition duration-150">
                            <div>{{ Auth::user()->name }}</div>
                            <div class="ms-1">
                                <svg class="fill-current h-4 w-4 text-gray-200" 
    ...
    <div :class="{'block': open, 'hidden': ! open}" 
         class="hidden sm:hidden bg-[#0f1a2b] text-white">
